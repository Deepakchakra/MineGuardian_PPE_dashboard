...
export const CHECKPOINTS: Checkpoint[] = [
  { id: "CP-01", name: "CHECKPOINT 1", x: 63, y: 33, status: "ACTIVE", description: "Main entrance checkpoint" },
  { id: "CP-02", name: "CHECKPOINT 2", x: 82, y: 35, status: "ACTIVE", description: "Upper tunnel crossing" },
  { id: "CP-03", name: "CHECKPOINT 3", x: 98, y: 40, status: "ACTIVE", description: "East tunnel crossing" },
  { id: "CP-04", name: "CHECKPOINT 4", x: 70, y: 76, status: "ACTIVE", description: "Lower tunnel crossing" },
  { id: "CP-05", name: "CHECKPOINT 5", x: 89, y: 93, status: "ACTIVE", description: "Deep mine crossing" },
];
